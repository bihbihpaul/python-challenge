...
with open(analysisfile, "w") as outputfile:
    ...
    outputfile.write("----------------------------\n")
    outputfile.write(f"Total Months:  {count_months}\n")
    outputfile.write(f"Total:  ${net_profit_loss}\n")
    outputfile.write(f"Average Change:  ${average_profit_loss}\n")
    outputfile.write(f"Greatest Increase in Profits:  {greatest_increase_month} (${highest_change})\n")
    outputfile.write(f"Greatest Decrease in Losses:  {greatest_decrease_month} (${lowest_change})\n")
